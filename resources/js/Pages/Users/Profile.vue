                                ...
                                <form class="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
                                    <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                                        ...
                                        <div class="sm:col-span-6">
                                            ...
                                            <div class="mt-1 flex rounded shadow-sm">
                                                <input type="text" name="username" id="username" :value="user.name" autocomplete="username" class="flex-1 block w-full min-w-0 border-blue-gray-300 rounded text-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <input type="text" name="email-address" :value="user.email" id="email-address" autocomplete="email" class="mt-1 block w-full border-blue-gray-300 rounded-md shadow-sm text-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
                                        </div>

                                        <div class="sm:col-span-3">
                                            <label for="provider" class="block text-sm font-medium text-blue-gray-900">
                                                provider
                                            </label>
                                            <input type="text" :value="user.provider" name="country" id="country" autocomplete="country" class="mt-1 block w-full border-blue-gray-300 rounded-md shadow-sm text-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500" />
                                        </div>
